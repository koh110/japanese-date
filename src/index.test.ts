...
test('match', () => {
  const arr = [
    ...
    { elem: '2時間半前', relative: -(2 * 60 * 60 + 30 * 60), type: 'seconds' },
    {
      elem: '10時',
      relative:
        (dayjs().hour(10).minute(0).second(0).toDate().getTime() - Date.now()) /
        1000,
      type: 'seconds',
    },
    {
      elem: '拾伍時',
      relative:
        (dayjs().hour(15).minute(0).second(0).toDate().getTime() - Date.now()) /
        1000,
      type: 'seconds',
    },
    {
      elem: '10時1分',
      relative:
        (dayjs().hour(10).minute(1).second(0).toDate().getTime() - Date.now()) /
        1000,
      type: 'seconds',
    },
    {
      elem: '十時二十分',
      relative:
        (dayjs().hour(10).minute(20).second(0).toDate().getTime() -
          Date.now()) /
        1000,
      type: 'seconds',
    },
    {
      elem: '十壱時半',
      relative:
        (dayjs().hour(11).minute(30).second(0).toDate().getTime() -
          Date.now()) /
        1000,
      type: 'seconds',
    },
    {
      elem: '十時二十分三十五秒',
      relative:
        (dayjs().hour(10).minute(20).second(35).toDate().getTime() -
          Date.now()) /
        1000,
      type: 'seconds',
    },
    {
      elem: '正午',
      relative:
        (dayjs().hour(12).minute(0).second(0).toDate().getTime() - Date.now()) /
        1000,
      type: 'seconds',
    },
  ];
